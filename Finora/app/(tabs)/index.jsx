...
export default function HomeScreen() {
  ...
  const loadDashboard = async () => {
    try {
      ...
      // Fetch AI insight lazily without blocking the UI
  ...
  useFocusEffect(useCallback(() => {
    setAiInsight(null); // Optional: Clear old insight on focus
    loadDashboard();
  }, []));
  const onRefresh = () => {
    setRefreshing(true);
    ...
    backgroundColor: '#F7F9FC'
      ...
      paddingBottom: Math.max(insets.bottom + 90, 110)
        ...
        elevation: 6
          ...
          marginTop: 4,
          marginBottom: 20
        }}>{formatCurrency(dashboard?.balance)}</Text>
          ...
          alignItems: 'center'
            ...
            gap: 10
              ...
              <View>
                ...
                marginTop: 1,
                color: '#10B981'
              }}>{formatCurrency(dashboard?.total_income)}</Text>
              </View>
            </View>
            <View style={{
            width: 1,
            ...
            gap: 10
              ...
              <View>
                ...
                marginTop: 1,
                color: '#EF4444'
              }}>{formatCurrency(dashboard?.total_expenses)}</Text>
              </View>
            </View>
          </View>
        </View>
        ...
        {dashboard?.monthly_budget > 0 && <View style={{
        marginHorizontal: 20,
        marginBottom: 16
      }}>
            <Text style={{
          ...
          elevation: 3
            ...
            marginBottom: 10
              ...
              fontWeight: '700',
              color: '#111827'
            }}>{formatCurrency(dashboard?.total_expenses)} spent</Text>
                <Text style={{
              fontSize: 13,
              color: '#6B7280'
            }}>of {formatCurrency(dashboard?.monthly_budget)}</Text>
              </View>
              <View style={{
            height: 10,
            backgroundColor: '#F3F4F6',
            ...
            overflow: 'hidden'
              ...
              borderRadius: 6,
              width: `${budgetUsed}%`,
              backgroundColor: budgetUsed > 85 ? '#EF4444' : '#2563EB'
            }} />
              </View>
              <Text style={{
            fontSize: 12,
            ...
            marginTop: 6,
            textAlign: 'right'
          }}>{budgetUsed.toFixed(0)}% used</Text>
            </View>
          </View>}
        ...
        marginBottom: 16
          ...
          elevation: 3
            ...
            fontWeight: '800',
            color: '#111827'
          }}>{formatCurrency(dashboard?.total_investments)}</Text>
            <Text style={{
            fontSize: 12,
            color: '#6B7280',
            fontWeight: '500'
          ...
          elevation: 3
            ...
            fontWeight: '800',
            color: '#111827'
          }}>{dashboard?.completed_goals}/{dashboard?.goals_count}</Text>
            <Text style={{
            fontSize: 12,
            color: '#6B7280',
            fontWeight: '500'
        ...
        marginBottom: 16
          ...
          {dashboard?.recent_transactions?.length === 0 ? <View style={{
          alignItems: 'center',
          paddingVertical: 30
        }}>
            ...
            borderRadius: 10
              ...
              fontWeight: '600',
              fontSize: 13
            }}>Add your first transaction</Text>
              </TouchableOpacity>
            </View> : dashboard?.recent_transactions?.map(tx => <TransactionItem key={tx.id} tx={tx} />)}
        </View>
        <View style={{
        height: 20
      }} />
