    ...
    <SafeAreaView style={{flex: 1,backgroundColor: '#F7F9FC'}} edges={['top']}>
      ...
      >
        ...
        <View style={{backgroundColor: '#2563EB',paddingHorizontal: 24,paddingBottom: 24,paddingTop: 12,flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center'}}>
          <View>
            <Text style={{fontSize: 14,color: 'rgba(255,255,255,0.8)',fontWeight: '500'}}>Good day, 👋</Text>
            <Text style={{fontSize: 22,fontWeight: '800',color: '#FFFFFF',marginTop: 2}}>{user?.full_name || user?.username || 'Welcome'}</Text>
          </View>
          <View style={{flexDirection: 'row', gap: 10}}>
            ...
            <TouchableOpacity onPress={() => router.push('/(tabs)/profile')} style={{width: 44,height: 44,borderRadius: 14,backgroundColor: 'rgba(255,255,255,0.15)',justifyContent: 'center',alignItems: 'center'}}>
        ...
        <View style={{margin: 20,marginTop: -2,backgroundColor: '#FFFFFF',borderRadius: 24,padding: 24,shadowColor: '#000',shadowOffset: {width: 0,height: 4},shadowOpacity: 0.08,shadowRadius: 12,elevation: 6}}>
          ...
          <View style={{flexDirection: 'row',alignItems: 'center'}}>
            ...
            <View style={{flex: 1,flexDirection: 'row',alignItems: 'center',gap: 10}}>
              <View style={[{width: 36,height: 36,borderRadius: 10,backgroundColor: '#D1FAE5',justifyContent: 'center',alignItems: 'center'}, { backgroundColor: '#FEE2E2' }]}>
        ...
        <View style={{marginHorizontal: 20,marginBottom: 16}}>
          <View style={{flexDirection: 'row',justifyContent: 'space-between',alignItems: 'center',marginBottom: 12}}>
            <Text style={{fontSize: 16,fontWeight: '700',color: '#111827',marginBottom: 12}}>Recent Transactions</Text>
