      ...
      paddingBottom: Math.max(insets.bottom + 100, 120)
        ...
        paddingTop: insets.top + 20
          ...
          position: 'relative'
            ...
            <TouchableOpacity onPress={() => setEditMode(!editMode)} style={{
            position: 'absolute',
            right: 0,
            width: 44,
            height: 44,
          ...
          marginTop: 30
            ...
            fontWeight: '500'
          }}>Joined {user?.created_at?.slice(0, 10)}</Text>
          </View>
        </LinearGradient>
        ...
        borderColor: '#F1F5F9'
          ...
          marginBottom: 18
            ...
            height: 50,
            ...(!editMode && { backgroundColor: '#F8FAFC', opacity: 0.7 })
          }}>
              <Ionicons name="person-outline" size={20} color={editMode ? "#9CA3AF" : "#D1D5DB"} style={{
              marginRight: 12
            }} />
              <TextInput style={{
              flex: 1,
          ...
          marginBottom: 18
            ...
            borderColor: '#F1F5F9'
              ...
              <Ionicons name="at-outline" size={20} color="#D1D5DB" style={{
              marginRight: 12
            }} />
              <TextInput style={{
              flex: 1,
              ...
              fontWeight: '500',
              color: '#6B7280'
            }} value={user?.username} editable={false} />
            </View>
          </View>
          ...
          marginBottom: 18
            ...
            borderColor: '#F1F5F9'
              ...
              <Ionicons name="mail-outline" size={20} color="#D1D5DB" style={{
              marginRight: 12
            }} />
              <TextInput style={{
              flex: 1,
          ...
          flexDirection: 'row'
            ...
            marginRight: 12
              ...
              ...(!editMode && { backgroundColor: '#F8FAFC', opacity: 0.7 })
                ...
                <Ionicons name="wallet-outline" size={20} color={editMode ? "#9CA3AF" : "#D1D5DB"} style={{
                marginRight: 12
              }} />
                <TextInput style={{
                flex: 1,
              ...
              }} value={budget} onChangeText={setBudget} keyboardType="decimal-pad" editable={editMode} placeholder="0.00" />
              </View>
            </View>
            ...
            flex: 0.6
              ...
              ...(!editMode && { backgroundColor: '#F8FAFC', opacity: 0.7 })
                ...
                <Ionicons name="cash-outline" size={20} color={editMode ? "#9CA3AF" : "#D1D5DB"} style={{
                marginRight: 12
              }} />
                <TextInput style={{
                flex: 1,
              ...
              }} value={currency} onChangeText={setCurrency} editable={editMode} maxLength={5} />
              </View>
            </View>
          </View>

          {editMode && <TouchableOpacity style={{
