...
<<<<<<< HEAD
          ...
          marginBottom: 18
            ...
            gap: 10
              ...
              {INVEST_TYPES.map(t => <TouchableOpacity key={t.id} style={{
              width: '23%',
              alignItems: 'center',
              padding: 8,
              backgroundColor: '#FFFFFF',
...
<<<<<<< HEAD
          ...
          marginBottom: 18
            ...
            fontSize: 15,
            color: '#111827'
          }} value={name} onChangeText={setName} placeholder="e.g. Apple Inc." placeholderTextColor="#9CA3AF" />
          </View>
          ...
          marginBottom: 18
            ...
            fontSize: 15,
            color: '#111827'
          }} value={symbol} onChangeText={setSymbol} placeholder="e.g. AAPL" autoCapitalize="characters" placeholderTextColor="#9CA3AF" />
          </View>
          ...
          flexDirection: 'row'
            ...
            flex: 1
              ...
              fontSize: 15,
              color: '#111827'
            }} value={amount} onChangeText={setAmount} keyboardType="decimal-pad" placeholder="0.00" placeholderTextColor="#9CA3AF" />
            </View>
            <View style={{
            width: 12
          }} />
            ...
            flex: 1
              ...
              fontSize: 15,
              color: '#111827'
            }} value={currentValue} onChangeText={setCurrentValue} keyboardType="decimal-pad" placeholder="Same as invested" placeholderTextColor="#9CA3AF" />
=======
          <View style={{marginBottom: 18}}>
...
<<<<<<< HEAD
          ...
          marginBottom: 18
            ...
            fontSize: 15,
            color: '#111827'
          }} value={purchaseDate} onChangeText={setPurchaseDate} placeholder="YYYY-MM-DD" placeholderTextColor="#9CA3AF" />
          </View>
          ...
          marginBottom: 18
            ...
            paddingTop: 12
          }} value={description} onChangeText={setDescription} placeholder="Details about this investment..." multiline placeholderTextColor="#9CA3AF" />
          </View>
          ...
          marginTop: 8,
          marginBottom: 20,
          backgroundColor: selectedType?.color || '#2563EB'
